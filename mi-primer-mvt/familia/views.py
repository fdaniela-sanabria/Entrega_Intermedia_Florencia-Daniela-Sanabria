...
from familia.forms import PersonaForm, BuscarPersonasForm, ActualizarPersonaForm, ProfesionFormulario

from familia.models import Persona, Profesion, Vinculo
...
def ProfesionFormulario(request):
    if request.method == 'POST':
        profesion = Profesion(request.POST['profesion'])
        profesion.save()
        return render(request, "familia/index.html")

    return render(request, "familia/ProfesionFormulario.html")
